...
class TestCaseEnterFromBookList(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            ...
            .with_json(
                {
                    "browsingDate": "2020-08-14T01:53:00.123Z",
                    "code": 2,
        ...
        Step(
            ...
            .with_params(
                **{
                    ...
                    "qp-storeCode-eq": "STORE000086",
                    "qp-memberCardCode-eq": "MCC20200714000091",
                    "qp-userCode-eq": "AC1282965982305976323",
                }
            )
            .with_headers(
                **{
...
if __name__ == "__main__":
    TestCaseEnterFromBookList().test_start()
