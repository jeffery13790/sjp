...
class TestCaseEnterFromActivity(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            RunRequest("/mall/homeTemplate/selectDefaultStoreCode")
                ...
                **{
                ...
                .assert_equal("body.data", "$storeCode")
        ),
        Step(
        ...
        Step(
            ...
            .with_json(
                {
                    "browsingDate": "{}T01:49:59.004Z".format(datetime.now().strftime('%Y-%m-%d')),
                    "code": "2",
...
if __name__ == "__main__":
    TestCaseEnterFromActivity().test_start()
