...
class TestCaseLogin(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            RunRequest("/ops/api/RwResultRecord/send")
            .get("/ops/api/RwResultRecord/send?")
            .with_headers(
                **{
        ...
        Step(
            RunRequest("/ops/api/RwResultRecord/send")
            .get("/ops/api/RwResultRecord/send")
            .with_params(**{"oddNumbers": "SR20200629000005"})
            .with_headers(
                **{
        ...
        Step(
            ...
            .with_params(**{"qp-realWarehouseName-like": ""})
            .with_headers(
                **{
        ...
        Step(
            RunRequest("/ops/api/RwResultRecord/send")
            .get("/ops/api/RwResultRecord/send")
            .with_params(**{"qp-outRealWarehouseCode-eq": "SC20200629000002"})
            .with_headers(
                **{
        ...
        Step(
            RunRequest("/ops/api/RwResultRecord/send")
            .get("/ops/api/RwResultRecord/send")
            .with_params(**{"qp-outRealWarehouseCode-eq": "SC20200629000003"})
            .with_headers(
                **{
        ...
        Step(
            RunRequest("/ops/api/RwResultRecord/send")
            .get("/ops/api/RwResultRecord/send")
            .with_params(**{"trackingNumber": "999999999999"})
            .with_headers(
                **{
        ...
        Step(
            ...
            .with_params(
                **{
                    ...
                    "qp-createTime-le": "2020-06-29 23:59:59",
                }
            )
            .with_headers(
                **{
        ...
        Step(
            RunRequest("/ops/api/RwResultRecord/send/detail")
            .get("/ops/api/RwResultRecord/send/detail")
            .with_params(**{"recordCode": "SR20200629000005"})
            .with_headers(
                **{
