...
class TestCaseLogin(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            ...
            .with_params(**{"current": "1", "pageSize": "500"})
            .with_headers(
                **{
        ...
        Step(
            RunRequest("/ops/api/category/getCategoryList")
            .get("/ops/api/category/getCategoryList?")
            .with_headers(
                **{
        ...
        Step(
            RunRequest("/ops/api/channelWarehouseStock/getChannelWarehouseStockList")
            .get(
                "/ops/api/channelWarehouseStock/getChannelWarehouseStockList?"
            )
            .with_headers(
                **{
        ...
        Step(
            ...
            .with_params(
                **{
                    "qp-channelWarehouseCode-eq": "CW20200629000001",
                    "qp-skuCode-eq": "XHSKU5795",
                    "qp-name-like": "蛤蟆的油",
                    "qp-categoryId-eq": "713067769779851264",
                    "qp-classId-eq": "1260581231525937154",
                    "qp-availableStock-gt": "0",
                }
            )
            .with_headers(
                **{
        ...
        Step(
            ...
            .with_params(**{"qp-channelWarehouseCode-eq": "CW20200629000001"})
            .with_headers(
                **{
