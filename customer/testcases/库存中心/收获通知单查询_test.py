...
class TestCaseLogin(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            RunRequest("/ops/api/rwNoticeRecord/receive")
            .get("/ops/api/rwNoticeRecord/receive?")
            .with_headers(
                **{
        ...
        Step(
            RunRequest("/ops/api/rwNoticeRecord/receive")
            .get("/ops/api/rwNoticeRecord/receive")
            .with_params(**{"qp-recordCode-eq": "ASN20200629000002"})
            .with_headers(
                **{
        ...
        Step(
            RunRequest("/ops/api/rwNoticeRecord/receive")
            .get("/ops/api/rwNoticeRecord/receive")
            .with_params(**{"qp-businessStatus-eq": "0"})
            .with_headers(
                **{
        ...
        Step(
            RunRequest("/ops/api/rwNoticeRecord/receive")
            .get("/ops/api/rwNoticeRecord/receive")
            .with_params(**{"qp-businessStatus-eq": "2"})
            .with_headers(
                **{
        ...
        Step(
            RunRequest("/ops/api/rwNoticeRecord/receive")
            .get("/ops/api/rwNoticeRecord/receive")
            .with_params(**{"qp-businessStatus-eq": "3"})
            .with_headers(
                **{
        ...
        Step(
            ...
            .with_params(
                **{
                    "qp-businessStatus-eq": "3",
                    "qp-businessCode-eq": "IT20200629000001",
                }
            )
            .with_headers(
                **{
        ...
        Step(
            RunRequest("/ops/api/rwNoticeRecord/receive/detail")
            .get("/ops/api/rwNoticeRecord/receive/detail")
            .with_params(**{"recordCode": "ASN20200629000002"})
            .with_headers(
                **{
