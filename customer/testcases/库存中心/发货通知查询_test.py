...
class TestCaseLogin(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            RunRequest("/ops/api/rwNoticeRecord/send")
            .get("/ops/api/rwNoticeRecord/send?")
            .with_headers(
                **{
        ...
        Step(
            RunRequest("/ops/api/rwNoticeRecord/send")
            .get("/ops/api/rwNoticeRecord/send")
            .with_params(**{"qp-recordCode-eq": "DON20200629000014"})
            .with_headers(
                **{
        ...
        Step(
            ...
            .with_params(
                **{
                    ...
                    "qp-businessCode-eq": "MALL20200629000014",
                }
            )
            .with_headers(
                **{
        ...
        Step(
            RunRequest("/ops/api/rwNoticeRecord/send")
            .get("/ops/api/rwNoticeRecord/send")
            .with_params(**{"qp-businessCode-eq": "MALL20200629000014"})
            .with_headers(
                **{
        ...
        Step(
            ...
            .with_params(
                **{
                    "qp-createTime-ge": "2020-06-02 00:00:00",
                    "qp-createTime-le": "2020-06-29 23:59:59",
                    "qp-businessCode-eq": "MALL20200629000022_10",
                }
            )
            .with_headers(
                **{
