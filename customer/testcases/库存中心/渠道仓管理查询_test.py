...
class TestCaseLogin(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            ...
            .with_params(
                **{
                    "qp-channelWarehouseName-like": "测试环境6-27的渠",
                    "qp-channelWarehouseCode-like": "CW20200627000002",
                }
            )
            .with_headers(
                **{
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # .assert_equal("body.traceId", "ac1400d215933274911332917d0001")
        ),
        Step(
            RunRequest("/ops/api/channelWarehouse/getChannelWarehouseList")
            .get(
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # .assert_equal("body.traceId", "ac1400d215933274971032919d0001")
        ),
        Step(
            RunRequest("/ops/api/channelWarehouse/getChannelWarehouseList")
            .get(
            ...
            .with_params(**{"qp-channelWarehouseCode-like": "CW2"})
            .with_headers(
                **{
                    # "Host": "cs1.jsbooks.com.cn",
                    "Connection": "keep-alive",
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # .assert_equal("body.traceId", "ac1400d215933275014822921d0001")
        ),
    ]


if __name__ == "__main__":
    TestCase渠道仓管理查询().test_start()
