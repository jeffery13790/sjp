...
class TestCaseLogin(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            RunRequest("/ops/api/rwStock/getRwStockList")
            .get("/ops/api/rwStock/getRwStockList?")
            .with_headers(
                **{
        ...
        Step(
            ...
            .get("/ops/api/rwStock/getRwStockList")
            .with_params(
                **{"currentPage": "1", "pageSize": "10", "qp-skuCode-eq": "XHSKU47141"}
            )
            .with_headers(
                **{
        ...
        Step(
            ...
            .with_params(
                **{
                    ...
                    "qp-name-like": "springboot",
                    "qp-categoryId-eq": "722852300328669184",
                    "qp-classId-eq": "1267997599515484162",
