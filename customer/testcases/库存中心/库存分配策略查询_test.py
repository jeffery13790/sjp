...
class TestCaseLogin(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            RunRequest("/ops/api/warehousePolicy/getWarehousePolicyList")
            .get(
                "/ops/api/warehousePolicy/getWarehousePolicyList"
            )
            .with_params(**{"qp-policyName-like": "测试环境6-27"})
            .with_headers(
                **{
                    # "Host": "cs1.jsbooks.com.cn",
                    "Connection": "keep-alive",
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # .assert_equal("body.traceId", "ac1400d215933265886422646d0001")
        ),
        Step(
            RunRequest("/ops/api/warehousePolicy/getWarehousePolicyList")
            .get(
            ...
            .with_params(**{"qp-policyCode-eq": "WP20200627000002"})
            .with_headers(
                **{
                    # "Host": "cs1.jsbooks.com.cn",
                    "Connection": "keep-alive",
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # .assert_equal("body.traceId", "ac1400d215933266048512651d0001")
        ),
        Step(
            RunRequest("/ops/api/warehousePolicy/getWarehousePolicyList")
            .get(
            ...
            .with_params(
                **{
                    "qp-policyCode-eq": "WP20200627000002",
                    "qp-realWarehouseCode-eq": "新华集团仓",
                }
            )
            .with_headers(
                **{
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # .assert_equal("body.traceId", "ac1400d215933266116902653d0001")
        ),
        Step(
            RunRequest("/ops/api/warehousePolicy/getWarehousePolicyList")
            .get(
            ...
            .with_params(
                **{
                    "qp-policyCode-eq": "WP20200627000002",
                    "qp-virtualWarehouseCode-eq": "接口测试虚拟仓",
                }
            )
            .with_headers(
                **{
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # .assert_equal("body.traceId", "ac1400d215933266263242657d0001")
        ),
        Step(
            RunRequest("/ops/api/warehousePolicy/getWarehousePolicyList")
            .get(
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # .assert_equal("body.traceId", "ac1400d215933266313842659d0001")
        ),
    ]


if __name__ == "__main__":
    TestCase库存分配策略查询().test_start()
