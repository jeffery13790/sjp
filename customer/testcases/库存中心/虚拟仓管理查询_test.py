...
class TestCaseLogin(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            ...
            .with_params(**{"qp-virtualWarehouseName-like": "测试环境6-27"})
            .with_headers(
                **{
        ...
        Step(
            ...
            .with_params(
                **{
                    "qp-virtualWarehouseName-like": "测试环境6-27",
                    "qp-virtualWarehouseCode-eq": "W20200627000002",
                }
            )
            .with_headers(
                **{
        ...
        Step(
            ...
            .with_params(
                **{
                    "qp-virtualWarehouseName-like": "测试环境6-27",
                    "qp-virtualWarehouseCode-eq": "VW20200627000002",
                }
            )
            .with_headers(
                **{
