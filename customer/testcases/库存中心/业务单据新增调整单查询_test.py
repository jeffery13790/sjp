        ...
        Step(
            ...
            .with_params(
                **{
                    "currentPage": "1",
                    "pageSize": "10",
                    "qp-channelWarehouseCode-like": "CW2",
                }
            )
            .with_headers(
                **{
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # .assert_equal("body.traceId", "ac1400d215933278326543023d0001")
        ),
        Step(
            RunRequest("/ops/api/rwFrontRecord/query")
            .get("/ops/api/rwFrontRecord/query?")
            .with_headers(
                **{
                    #  "Host": "cs1.jsbooks.com.cn",
                    "Connection": "keep-alive",
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # .assert_equal("body.traceId", "ac1400d215933278373293025d0001")
        ),
        Step(
            RunRequest("/ops/api/rwFrontRecord/query")
            .get("/ops/api/rwFrontRecord/query")
            .with_params(**{"qp-outRealWarehouseCode-eq": "XHWAREHOUSE1_0_11"})
            .with_headers(
                **{
                    #  "Host": "cs1.jsbooks.com.cn",
                    "Connection": "keep-alive",
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # .assert_equal("body.traceId", "ac1400d215933278567253030d0001")
        ),
        Step(
            RunRequest("/ops/api/rwFrontRecord/query")
            .get("/ops/api/rwFrontRecord/query")
            .with_params(
                **{
                    "qp-recordCode-eq": "IT20200611000001",
                    "qp-outRealWarehouseCode-eq": "XHWAREHOUSE1_0_11",
                }
            )
            .with_headers(
                **{
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # .assert_equal("body.traceId", "ac1400d215933278647913033d0001")
        ),
        Step(
            RunRequest("/ops/api/rwFrontRecord/query")
            .get("/ops/api/rwFrontRecord/query")
            .with_params(**{"qp-recordStatus-eq": "0"})
            .with_headers(
                **{
                    #  "Host": "cs1.jsbooks.com.cn",
                    "Connection": "keep-alive",
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # .assert_equal("body.traceId", "ac1400d215933278771933036d0001")
        ),
        Step(
            RunRequest("/ops/api/rwFrontRecord/query")
            .get("/ops/api/rwFrontRecord/query")
            .with_params(**{"qp-recordStatus-eq": "1"})
            .with_headers(
                **{
                    #  "Host": "cs1.jsbooks.com.cn",
                    "Connection": "keep-alive",
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # .assert_equal("body.traceId", "ac1400d215933278812003038d0001")
        ),
        Step(
            RunRequest("/ops/api/rwFrontRecord/query")
            .get("/ops/api/rwFrontRecord/query")
            .with_params(**{"qp-recordStatus-eq": "2"})
            .with_headers(
                **{
                    #  "Host": "cs1.jsbooks.com.cn",
                    "Connection": "keep-alive",
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # .assert_equal("body.traceId", "ac1400d215933278846973040d0001")
        ),
        Step(
            RunRequest("/ops/api/rwFrontRecord/query")
            .get("/ops/api/rwFrontRecord/query")
            .with_params(**{"qp-recordStatus-eq": "3"})
            .with_headers(
                **{
                    #  "Host": "cs1.jsbooks.com.cn",
                    "Connection": "keep-alive",
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # .assert_equal("body.traceId", "ac1400d215933278879023041d0001")
        ),
        Step(
            RunRequest("/ops/api/rwFrontRecord/query")
            .get("/ops/api/rwFrontRecord/query")
            .with_params(**{"qp-recordStatus-eq": "4"})
            .with_headers(
                **{
                    #  "Host": "cs1.jsbooks.com.cn",
                    "Connection": "keep-alive",
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # .assert_equal("body.traceId", "ac1400d215933278912713043d0001")
        ),
        Step(
            RunRequest("/ops/api/rwFrontRecord/query")
            .get("/ops/api/rwFrontRecord/query")
            .with_params(
                **{
                    "qp-recordStatus-eq": "4",
                    "qp-createTime-ge": "2020-06-01 00:00:00",
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # .assert_equal("body.traceId", "ac1400d215933278983973045d0001")
        ),
        Step(
            RunRequest("/ops/api/rwFrontRecord/query")
            .get("/ops/api/rwFrontRecord/query?")
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # .assert_equal("body.traceId", "ac1400d215933279056103048d0001")
        ),
    ]


if __name__ == "__main__":
    TestCase业务单据新增调整单查询().test_start()
