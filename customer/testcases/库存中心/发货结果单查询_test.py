...
class TestCaseLogin(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            RunRequest("/ops/api/RwResultRecord/receive")
            .get("/ops/api/RwResultRecord/receive?")
            .with_headers(
                **{
                    "Connection": "keep-alive",
                    "Accept": "application/json",
        ...
        Step(
            RunRequest("/ops/api/RwResultRecord/receive")
            .get("/ops/api/RwResultRecord/receive")
            .with_params(**{"oddNumbers": "RO20200629000002"})
            .with_headers(
                **{
                    "Host": "cs1.jsbooks.com.cn",
                    "Connection": "keep-alive",
        ...
        Step(
            RunRequest("/ops/api/RwResultRecord/receive")
            .get("/ops/api/RwResultRecord/receive")
            .with_params(**{"qp-inRealWarehouseCode-eq": "SC20200629000002"})
            .with_headers(
                **{
                    "Host": "cs1.jsbooks.com.cn",
                    "Connection": "keep-alive",
        ...
        Step(
            RunRequest("/ops/api/RwResultRecord/receive")
            .get("/ops/api/RwResultRecord/receive")
            .with_params(**{"trackingNumber": "ZT10393736718199"})
            .with_headers(
                **{
                    "Host": "cs1.jsbooks.com.cn",
                    "Connection": "keep-alive",
        ...
        Step(
            RunRequest("/ops/api/RwResultRecord/receive/detail")
            .get("/ops/api/RwResultRecord/receive/detail")
            .with_params(**{"recordCode": "RO20200629000002"})
            .with_headers(
                **{
                    "Host": "cs1.jsbooks.com.cn",
                    "Connection": "keep-alive",
