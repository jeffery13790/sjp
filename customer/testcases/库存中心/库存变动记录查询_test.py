...
class TestCaseLogin(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            RunRequest("/ops/api/rwStockChangeLog")
            .get("/ops/api/rwStockChangeLog?")
            .with_headers(
                **{
        ...
        Step(
            ...
            .with_params(
                **{
                    "qp-realWarehouseCode-eq": "SC20200629000002",
                    "qp-skuCode-eq": "XHSKU47141",
                    "qp-itemName-like": "胜利时刻",
                    "qp-modifyTime-ge": "2020-06-01 00:00:00",
                    "qp-modifyTime-le": "2020-06-29 23:59:59",
                }
            )
            .with_headers(
                **{
        ...
        Step(
            RunRequest("/ops/api/rwStockChangeLog")
            .get("/ops/api/rwStockChangeLog")
            .with_params(**{"qp-realWarehouseCode-eq": "SC20200629000002"})
            .with_headers(
                **{
        ...
        Step(
            RunRequest("/ops/api/rwStockChangeLog")
            .get("/ops/api/rwStockChangeLog")
            .with_params(**{"qp-realWarehouseCode-eq": "SC20200513000002"})
            .with_headers(
                **{
        ...
        Step(
            RunRequest("/ops/api/rwStockChangeLog")
            .get("/ops/api/rwStockChangeLog")
            .with_params(**{"qp-realWarehouseCode-eq": "XHWAREHOUSE1_0_11"})
            .with_headers(
                **{
