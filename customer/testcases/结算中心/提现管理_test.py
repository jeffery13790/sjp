...
class TestCaseLogin(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            RunRequest("/ops/api/applicationWithdraw/queryPage")
            .get("/ops/api/applicationWithdraw/queryPage?")
            .with_headers(
                **{
        ...
        Step(
            RunRequest("/ops/api/applicationWithdraw/getAllKindMoney")
            .get(
                "/ops/api/applicationWithdraw/getAllKindMoney?"
            )
            .with_headers(
                **{
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # # .assert_equal("body.traceId", "ac1400d215934952112417519d0001")
        ),
        Step(
            RunRequest("/ops/api/business/query")
            .get("/ops/api/business/query")
            .with_params(**{"qp-regType-eq": "2"})
            .with_headers(
                **{
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # # .assert_equal("body.traceId", "ac1400d215934952112747520d0001")
        ),
        Step(
            RunRequest("/ops/api/applicationWithdraw/getAllKindMoney")
            .get(
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # # .assert_equal("body.traceId", "ac1400d215934952204557523d0001")
        ),
        Step(
            RunRequest("/ops/api/applicationWithdraw/queryPage")
            .get("/ops/api/applicationWithdraw/queryPage")
            .with_params(
                **{
                    "qp-customerNo-eq": "AB1277416704574717954",
                    "qp-applicationTime-gt": "2020-06-01 00:00:00",
                    "qp-applicationTime-lt": "2020-06-30 23:59:59",
                }
            )
            .with_headers(
                **{
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # # .assert_equal("body.traceId", "ac1400d215934952204557524d0001")
        ),
        Step(
            RunRequest("/ops/api/applicationWithdraw/queryPage")
            .get("/ops/api/applicationWithdraw/queryPage?")
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # # .assert_equal("body.traceId", "ac1400d215934952223507525d0001")
        ),
        Step(
            RunRequest("/ops/api/applicationWithdraw/getAllKindMoney")
            .get(
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # # .assert_equal("body.traceId", "ac1400d215934952320427528d0001")
        ),
        Step(
            RunRequest("/ops/api/applicationWithdraw/queryPage")
            .get("/ops/api/applicationWithdraw/queryPage")
            .with_params(**{"qp-customerNo-eq": "AB1274879873250832385"})
            .with_headers(
                **{
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # # .assert_equal("body.traceId", "ac1400d215934952320467529d0001")
        ),
        Step(
            RunRequest("/ops/api/applicationWithdraw/queryPage")
            .get("/ops/api/applicationWithdraw/queryPage?")
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # # .assert_equal("body.traceId", "ac1400d215934952380627531d0001")
        ),
        Step(
            RunRequest("/ops/api/applicationWithdraw/queryDetail")
            .get("/ops/api/applicationWithdraw/queryDetail")
            .with_params(**{"id": "713423360532811776"})
            .with_headers(
                **{
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # # .assert_equal("body.traceId", "ac1400d215934952466317534d0001")
        ),
    ]


if __name__ == "__main__":
    TestCase提现管理().test_start()
