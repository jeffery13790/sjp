...
class TestCaseLogin(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            ...
            .with_params(**{"id": "1277415349818720258"})
            .with_headers(
                **{
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # # .assert_equal("body.traceId", "ac1400d215934874176895708d0001")
        ),
        Step(
            RunRequest("/ops/api/customer/getOne")
            .get("/ops/api/customer/getOne")
            .with_params(**{"customerCode": "AB1277415349755805697"})
            .with_headers(
                **{
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # # .assert_equal("body.traceId", "ac1400d215934874177095709d0001")
        ),
        Step(
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # # .assert_equal("body.traceId", "ac1400d215934874177175710d0001")
        ),
        Step(
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # # .assert_equal("body.traceId", "ac1400d215934874177385711d0001")
        ),
        Step(
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # # .assert_equal("body.traceId", "ac1400d215934874177405712d0001")
        ),
        Step(
            RunRequest("/ops/api/business/queryQualifications")
            .get("/ops/api/business/queryQualifications")
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # # .assert_equal("body.traceId", "ac1400d215934874273375715d0001")
        ),
        Step(
            RunRequest("/ops/api/settlementRule/queryDistribution")
            .get("/ops/api/settlementRule/queryDistribution")
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # # .assert_equal("body.traceId", "ac1400d215934874392585718d0001")
        ),
        Step(
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # # .assert_equal("body.traceId", "ac1400d215934874463955721d0001")
        ),
    ]


if __name__ == "__main__":
    TestCase商家查看().test_start()
