...
class TestCaseLogin(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            ...
            .with_params(**{"qp-combination-eq": "true", "qp-ownerId-eq": "1"})
            .with_headers(
                **{
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            #.assert_equal("body.traceId", "ac1400d215934475154231786d0001")
        ),
        Step(
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            #.assert_equal("body.traceId", "ac1400d215934475154261787d0001")
        ),
        Step(
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            #.assert_equal("body.traceId", "ac1400d215934475154301788d0001")
        ),
        Step(
            RunRequest("/ops/api/business/query")
            .get("/ops/api/business/query")
            .with_params(
                **{"currentPage": "1", "pageSize": "500", "qp-regType-eq": "2"}
            )
            .with_headers(
                **{
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            #.assert_equal("body.traceId", "ac1400d215934475154361789d0001")
        ),
        Step(
            RunRequest("/ops/api/item/getItemList")
            .get("/ops/api/item/getItemList")
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            #.assert_equal("body.traceId", "ac1400d215934475259721792d0001")
        ),
        Step(
            RunRequest("/ops/api/item/getItemList")
            .get("/ops/api/item/getItemList")
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            #.assert_equal("body.traceId", "ac1400d215934475300401794d0001")
        ),
        Step(
            RunRequest("/ops/api/item/getItemList")
            .get("/ops/api/item/getItemList")
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            #.assert_equal("body.traceId", "ac1400d215934475330531795d0001")
        ),
        Step(
            RunRequest("/ops/api/item/getItemList")
            .get("/ops/api/item/getItemList")
            .with_params(
                **{
                    "qp-combination-eq": "true",
                    "qp-storeCode-eq": "1277416704629243906",
                    "qp-ownerId-eq": "1",
                }
            )
            .with_headers(
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            #.assert_equal("body.traceId", "ac1400d215934475371231797d0001")
        ),
    ]


if __name__ == "__main__":
    TestCase组合商品查询().test_start()
