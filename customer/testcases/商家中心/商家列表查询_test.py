...
class TestCaseLogin(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # # .assert_equal("body.traceId", "ac1400d215934873244575686d0001")
        ),
        Step(
            RunRequest("/ops/api/business/query")
            .get("/ops/api/business/query")
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # # .assert_equal("body.traceId", "ac1400d215934873374825689d0001")
        ),
        Step(
            RunRequest("/ops/api/business/query")
            .get("/ops/api/business/query")
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # # .assert_equal("body.traceId", "ac1400d215934873416575691d0001")
        ),
        Step(
            RunRequest("/ops/api/business/query")
            .get("/ops/api/business/query")
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # # .assert_equal("body.traceId", "ac1400d215934873521485694d0001")
        ),
    ]


if __name__ == "__main__":
    TestCase商家列表查询().test_start()
