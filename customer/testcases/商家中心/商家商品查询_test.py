...
class TestCaseLogin(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            ...
            .with_params(**{"qp-combination-eq": "false", "qp-ownerId-eq": "1"})
            .with_headers(
                **{
        ...
        Step(
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            #.assert_equal("body.traceId", "ac1400d215934474816881776d0001")
        ),
        Step(
            RunRequest("/ops/api/item/getItemList")
            .get("/ops/api/item/getItemList")
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            #.assert_equal("body.traceId", "ac1400d215934474867251778d0001")
        ),
        Step(
            RunRequest("/ops/api/item/getItemList")
            .get("/ops/api/item/getItemList")
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            #.assert_equal("body.traceId", "ac1400d215934474916361780d0001")
        ),
    ]


if __name__ == "__main__":
    TestCase商家商品查询().test_start()
