...
class TestCaseLogin(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            #.assert_equal("body.traceId", "ac1400d215934475729661805d0001")
        ),
        Step(
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            #.assert_equal("body.traceId", "ac1400d215934475729741806d0001")
        ),
        Step(
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            #.assert_equal("body.traceId", "ac1400d215934475729801807d0001")
        ),
        Step(
            RunRequest("/ops/api/item/getItemList")
            .get("/ops/api/item/getItemList")
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            #.assert_equal("body.traceId", "ac1400d215934475799571810d0001")
        ),
        Step(
            RunRequest("/ops/api/item/getItemList")
            .get("/ops/api/item/getItemList")
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            #.assert_equal("body.traceId", "ac1400d215934475830861811d0001")
        ),
        Step(
            RunRequest("/ops/api/item/getItemList")
            .get("/ops/api/item/getItemList")
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            #.assert_equal("body.traceId", "ac1400d215934475853101813d0001")
        ),
        Step(
            RunRequest("/ops/api/item/getItemList")
            .get("/ops/api/item/getItemList")
            .with_params(**{"qp-combination-eq": "true", "qp-ownerId-eq": "0"})
            .with_headers(
                **{
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            #.assert_equal("body.traceId", "ac1400d215934475883111814d0001")
        ),
    ]


if __name__ == "__main__":
    TestCase集团组合商品查询().test_start()
