...
class TestCaseLogin(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            RunRequest("/ops/api/reverseOrder/query")
            .get("/ops/api/reverseOrder/query")
            .with_params(**{"qp-orderNo-eq": "MALL20200624000002"})
            .with_headers(
                **{
                    # "Host": "cs1.jsbooks.com.cn",
                    "Connection": "keep-alive",
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # .assert_equal("body.traceId", "ac1400d215933260040942486d0001")
        ),
        Step(
            RunRequest("/ops/api/store/query")
            .get("/ops/api/store/query")
            .with_params(**{"qp-storeName-like": "您好店铺"})
            .with_headers(
                **{
                    # "Host": "cs1.jsbooks.com.cn",
                    "Connection": "keep-alive",
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # .assert_equal("body.traceId", "ac1400d215933260319892493d0001")
        ),
        Step(
            RunRequest("/ops/api/reverseOrder/query")
            .get("/ops/api/reverseOrder/query")
            .with_params(
                **{
                    "qp-orderNo-eq": "MALL20200624000002",
                    "qp-storeCode-eq": "STORE000014",
                }
            )
            .with_headers(
                **{
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # .assert_equal("body.traceId", "ac1400d215933260381432495d0001")
        ),
        Step(
            RunRequest("/ops/api/reverseOrder/query")
            .get("/ops/api/reverseOrder/query")
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # .assert_equal("body.traceId", "ac1400d215933260478942498d0001")
        ),
        Step(
            RunRequest("/ops/api/reverseOrder/query")
            .get("/ops/api/reverseOrder/query")
            ...
            .assert_equal("body.code", "000000")
            .assert_equal("body.msg", "Success")
            # .assert_equal("body.traceId", "ac1400d215933260565072501d0001")
        ),
    ]


if __name__ == "__main__":
    TestCase售后管理查询().test_start()
