...
class TestCaseLogin(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            ...
            .with_params(**{"qp-templateName-eq": "满减"})
            .with_headers(
                **{
        ...
        Step(
            ...
            .with_params(
                **{
                    "qp-templateName-eq": "满减",
                    "qp-activityName-like": "满减",
                    "qp-activityNo-eq": "HD20200629000008",
                    "qp-activityStart-ge": "2020-06-01 00:00:00",
                    "qp-activityStart-le": "2020-06-29 23:59:59",
                    "qp-activityStatus-in": "0",
                }
            )
            .with_headers(
                **{
        ...
        Step(
            RunRequest("/ops/api/activity/query")
            .get("/ops/api/activity/query")
            .with_params(**{"qp-templateName-eq": "限时折扣"})
            .with_headers(
                **{
        ...
        Step(
            RunRequest("/ops/api/activity/query")
            .get("/ops/api/activity/query")
            .with_params(**{"qp-templateName-eq": "限时特价"})
            .with_headers(
                **{
        ...
        Step(
            ...
            .get("/ops/api/activity/query")
            .with_params(
                **{"qp-templateName-eq": "限时特价", "currentPage": "10", "pageSize": "10"}
            )
            .with_headers(
                **{
