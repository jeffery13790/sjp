...
class TestCaseLogin(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            RunRequest("/ops/api/ticket/query")
            .get("/ops/api/ticket/query")
            .with_params(**{"qp-ticketName-like": "app优惠券001"})
            .with_headers(
                **{
        ...
        Step(
            RunRequest("/ops/api/ticket/query")
            .get("/ops/api/ticket/query")
            .with_params(**{"qp-ticketName-like": "app优惠券001", "qp-ticketType-in": "2"})
            .with_headers(
                **{
        ...
        Step(
            ...
            .with_params(
                **{
                    "qp-effectivetimeStart-ge": "2020-06-01 00:00:00",
                    "qp-effectivetimeStart-le": "2020-06-29 23:59:59",
                }
            )
            .with_headers(
                **{
        ...
        Step(
            ...
            .with_params(
                **{
                    "qp-ticketCode-eq": "TK20200629000004",
                    "qp-effectivetimeStart-ge": "2020-06-01 00:00:00",
                    "qp-effectivetimeStart-le": "2020-06-29 23:59:59",
                }
            )
